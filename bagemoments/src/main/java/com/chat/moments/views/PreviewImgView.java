...
public class PreviewImgView extends ImageViewerPopupView {
    ...
    protected void onCreate() {
        ...
        imageView.setOnClickListener(view -> BageDialogUtils.getInstance().showDialog(context, context.getString(R.string.delete_img), context.getString(R.string.delete_img_tips), true,"", context.getString(R.string.base_delete), 0, ContextCompat.getColor(context, R.color.red), index -> {
            if (index == 1) {
