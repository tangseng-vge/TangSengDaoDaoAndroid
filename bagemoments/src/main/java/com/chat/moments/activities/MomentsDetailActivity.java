 ...
 * 动态详情
 */
public class MomentsDetailActivity extends BageBaseActivity<ActMomentsDetailLayoutBinding> {
                ...
                if (view1.getId() == R.id.contentStatusTv) {
                    ...
                    FeedActionPopup feedActionPopup = new FeedActionPopup(this, isLiked, showModerationActions, type -> {
                        if (type == 1) {
                            ...
                            bageVBinding.recyclerView.smoothScrollBy(0, location[1] + BageConstants.getKeyboardHeight() + AndroidUtilities.dp(88) - AndroidUtilities.getScreenHeight());
...
//                            bageVBinding.emojiPanelView.showEmojiPanel(getString(R.string.moments_reply));
                    ...
                    BageDialogUtils.getInstance().showDialog(this, getString(R.string.delete_moments_tips), getString(R.string.delete_moments_tips), true, "", getString(R.string.base_delete), 0, ContextCompat.getColor(this, R.color.red), index -> {
                        if (index == 1) {
        ...
        adapter.setReplyClick(((momentNo, reply, locationY) -> {
            bageVBinding.recyclerView.smoothScrollBy(0, locationY + BageConstants.getKeyboardHeight() + AndroidUtilities.dp(48) - AndroidUtilities.getScreenHeight());
...
//        bageVBinding.emojiPanelView.addOnInputResult(content -> MomentsModel.getInstance().comments(momentNo, content, replyMomentsReply == null ? "" : replyMomentsReply.sid, replyMomentsReply == null ? "" : replyMomentsReply.uid, replyMomentsReply == null ? "" : replyMomentsReply.name, (code, msg, commentID) -> {
//            if (code == HttpResponseCode.success) {
//
