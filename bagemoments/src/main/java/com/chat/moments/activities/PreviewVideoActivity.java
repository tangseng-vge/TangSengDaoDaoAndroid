...
public class PreviewVideoActivity extends GSYBaseActivityDetail<VideoPlayer> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.titleRightLayout).setOnClickListener(v -> BageDialogUtils.getInstance().showDialog(PreviewVideoActivity.this, getString(R.string.delete_video), getString(R.string.delete_video_tips), true, "", getString(R.string.moments_delete), 0, ContextCompat.getColor(PreviewVideoActivity.this, R.color.red), index -> {
            if (index == 1) {
    ...
    public void initVideo() {
        ...
        if (TextUtils.isEmpty(url)) {
            BageToastUtils.getInstance().showToast(getString(com.chat.base.R.string.video_deleted));
            finish();
            return;
        }
        playUrl = url;
