 ...
 */
final class WKClientSSLContext extends SSLContext {
    private WKClientSSLContext(SSLContext delegate, String peerHost, int peerPort) {
    ...
    static SSLContext create(String peerHost, int peerPort) throws GeneralSecurityException {
        ...
        return new WKClientSSLContext(delegate, peerHost.trim(), peerPort);
    }
