...
//        sHasCallbackPaths.clear();
    ...
    private synchronized void handleMediaContentChange(Uri contentUri) {
        ...
        try {
            ...
            cursor = BageBaseApplication.getInstance().getContext().getContentResolver().query(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, MEDIA_PROJECTIONS_API_16,
