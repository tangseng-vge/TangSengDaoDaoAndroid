...
public class ReactionStickerUtils {
    ...
    private static Map<String, Integer> getMaps(List<BageMsgReaction> list) {
    ...
    private static List<String> getEmojis(List<BageMsgReaction> list) {
    ...
    public static void refreshMsgReactionsData(FrameLayout parentView, ChatAdapter chatAdapter, BageChatIteMsgFromType from, List<BageMsgReaction> list) {
        ...
        if (parentView.getChildCount() != 0 && BageReader.isEmpty(list)) {
    ...
    public static void setMsgReactionsData(FrameLayout parentView, ChatAdapter chatAdapter, BageChatIteMsgFromType from, List<BageMsgReaction> list) {
        ...
        param.gravity = from == BageChatIteMsgFromType.SEND ? Gravity.START : Gravity.END;
        param.topMargin = -AndroidUtilities.dp(10);
        param.leftMargin = AndroidUtilities.dp(from == BageChatIteMsgFromType.SEND ? 5 : 0);
        param.rightMargin = AndroidUtilities.dp(from == BageChatIteMsgFromType.SEND ? 0 : 5);
    ...
    private static View getPersonalView(String emoji, ChatAdapter chatAdapter, String uid) {
        ...
        avatar.showAvatar(uid, BageChannelType.PERSONAL);
