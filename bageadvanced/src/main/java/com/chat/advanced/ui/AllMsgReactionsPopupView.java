...
public class AllMsgReactionsPopupView extends BottomPopupView {
    ...
    private final List<BageMsgReaction> allList = new ArrayList<>();
    private final Map<String, Integer> map = new HashMap<>();
    List<Fragment> list;
    ViewPager2 viewPager;

    public AllMsgReactionsPopupView(@NonNull Context context, List<BageMsgReaction> list, Map<String, Integer> map) {
        super(context);
        this.map.putAll(map);
    ...
    protected void onCreate() {
        ...
        BageFragmentStateAdapter fragmentStateAdapter = new BageFragmentStateAdapter(context, list);
