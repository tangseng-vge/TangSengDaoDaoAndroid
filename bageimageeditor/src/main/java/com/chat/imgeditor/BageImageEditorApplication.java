...
public class BageImageEditorApplication {

    private static final int MAX_WIDTH = 1024;
    private static final int MAX_HEIGHT = 1024;

    private static class ImageEditorApplicationBinder {
        final static BageImageEditorApplication instance = new BageImageEditorApplication();
    }

    public static BageImageEditorApplication getInstance() {
