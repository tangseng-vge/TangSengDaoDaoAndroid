 ...
 * 管理表情
 */
class StickerManagerActivity : BageBaseActivity<ActMyStickerLayoutBinding>() {
    ...
    override fun initListener() {
        ...
        EndpointManager.getInstance()
            .setMethod("", EndpointCategory.bageRefreshStickerCategory) {
    ...
    private fun getHeader(): View {
        val view = LayoutInflater.from(this)
            .inflate(R.layout.sticker_manager_header, bageVBinding.recyclerView, false)
