...
class StickerStoreDetailActivity : BageBaseActivity<ActStickerStoreDetailLayoutBinding>() {
    ...
    override fun initListener() {
        bageVBinding.recyclerView.addOnItemTouchListener(
            SimpleMovePreviewListener(
                bageVBinding.recyclerView,
            ...
            object : StickerModel.IStickerDetailListener {
                override fun onResult(code: Int, msg: String, stickerDetail: StickerDetail?) {
                    if (code == HttpResponseCode.success.toInt()) {
                        ...
                        bageVBinding.titleTv.text = stickerDetail.title
                        bageVBinding.descTv.text = stickerDetail.desc
                        titleTv.text = stickerDetail.title
                        if (!stickerDetail.added) {
                            bageVBinding.addBtn.setText(R.string.str_sticker_add)
            ...
            if (stickerUI.sticker != null) {
                ...
                if (file.exists()) {
                    ...
                    Glide.with(context).asGif()
                        .load(BageApiConfig.getShowUrl(stickerUI.sticker!!.path))
                        .apply(GlideRequestOptions.getInstance().normalRequestOption())
                        .into(stickerView.imageView)
                }
