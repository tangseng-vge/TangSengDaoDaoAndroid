 ...
 * 登录验证
 */
public class LoginAuthActivity extends BageBaseActivity<ActLoginAuthLayoutBinding> {
    ...
    protected void initView() {
        bageVBinding.loginAuthBtn.getBackground().setTint(Theme.colorAccount);
        bageVBinding.loginAuthDescTv.setText(String.format(getString(R.string.login_auth_desc), getString(R.string.app_name)));
        phone = getIntent().getStringExtra("phone");
        bageVBinding.phoneNumTv.setText(phone);
        uid = getIntent().getStringExtra("uid");
    }

    @Override
    protected void initListener() {
        bageVBinding.loginAuthBtn.setOnClickListener(v -> LoginModel.getInstance().sendLoginAuthVerifCode(uid, (code, msg) -> {
