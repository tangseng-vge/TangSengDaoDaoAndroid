...
public class CryptoUtils {
    ...
    public byte[] aesEncrypt(String sSrc) {
        ...
        try {
           ...
           BageLoggerUtils.getInstance().e(TAG,"aesEncrypt encrypt error");
           return null;
        }
        if (encrypted == null) {
            BageLoggerUtils.getInstance().e(TAG, "aesEncrypt The encrypted data is empty");
    ...
    public String aesDecrypt(byte[] sSrc) {
        ...
        try {
            ...
            BageLoggerUtils.getInstance().e(TAG, "aesDecrypt Decryption error");
        }
    ...
    public boolean checkRSASign(String content, String sign) {
        try {
            String publicKey = BageIMApplication.getInstance().getRSAPublicKey();
