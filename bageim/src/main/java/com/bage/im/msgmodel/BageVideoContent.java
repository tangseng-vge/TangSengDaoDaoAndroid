 ...
 * 内置视频消息
 */
public class BageVideoContent extends BageMediaMessageContent {
    public String cover;
    ...
    // 无参构造必须提供
    public BageVideoContent() {
        type = BageMsgContentType.Bage_VIDEO;
    }
    ...
    protected BageVideoContent(Parcel in) {
        super(in);
        cover = in.readString();
    ...
    public static final Parcelable.Creator<BageVideoContent> CREATOR = new Parcelable.Creator<BageVideoContent>() {
        @Override
        public BageVideoContent createFromParcel(Parcel in) {
            return new BageVideoContent(in);
        }

        @Override
        public BageVideoContent[] newArray(int size) {
            return new BageVideoContent[size];
        }
    };
