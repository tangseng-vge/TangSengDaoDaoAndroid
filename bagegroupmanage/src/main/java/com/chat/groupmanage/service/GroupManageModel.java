 ...
 * 群管理model
 */
public class GroupManageModel extends BageBaseModel {
    ...
    public void uploadAvatar(String groupNO, String filePath, IUploadBack iUploadBack) {
        String url = BageApiConfig.baseUrl + "groups/" + groupNO + "/avatar?uuid=" + BageTimeUtils.getInstance().getCurrentMills();
