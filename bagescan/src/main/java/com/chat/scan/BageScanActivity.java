 ...
 * 扫描页面
 */
public class BageScanActivity extends BarcodeCameraScanActivity {
    ...
    private void handleResult(String result) {
        ScanUtils.getInstance().handleScanResult(BageScanActivity.this, result, new ScanUtils.IHandleScanResult() {
            @Override
            public void showOtherContent(String content) {
                Intent intent = new Intent(BageScanActivity.this, BageScanOtherResultActivity.class);
            ...
            public void showWebView(String url) {
                Intent intent = new Intent(BageScanActivity.this, BageWebViewActivity.class);
                    ...
                    new Thread(() -> {
                        ...
                        runOnUiThread(() -> {
                            if (TextUtils.isEmpty(result)) {
                                BageToastUtils.getInstance().showToast(getString(R.string.bage_scan_module_scan_no_result));
                                return;
                            }
                            handleResult(result);
                        });
