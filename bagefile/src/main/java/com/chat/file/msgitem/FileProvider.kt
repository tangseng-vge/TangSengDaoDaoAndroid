...
class FileProvider : BageChatBaseProvider() {
    ...
    override fun setData(
        ...
        val fileContent = uiChatMsgItemEntity.bageMsg.baseContentMsgModel as FileContent
    ...
    override fun resetCellBackground(
        ...
        contentLayout.setAll(bgType, from, BageContentType.Bage_FILE)
    }
