 ...
 * 文件类型
 */
public class FileContent extends BageMediaMessageContent {
    public String name;
    public long size;

    public FileContent() {
        type = BageMsgContentType.Bage_FILE;
    }
    ...
    public String getDisplayContent() {
        return BageBaseApplication.getInstance().getContext().getString(R.string.last_msg_file);
    }
