...
public class RobotMenuAdapter extends BaseQuickAdapter<BageRobotMenuEntity, BaseViewHolder> {
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder baseViewHolder, BageRobotMenuEntity entity) {
        ...
        avatarView.showAvatar(entity.robot_id, BageChannelType.PERSONAL);
    }
}
