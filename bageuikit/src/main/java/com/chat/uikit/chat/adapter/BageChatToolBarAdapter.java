 ...
 * 工具栏
 */
public class BageChatToolBarAdapter extends BaseQuickAdapter<ChatToolBarMenu, BaseViewHolder> {
    public BageChatToolBarAdapter() {
        super(R.layout.bage_item_chat_tool_bar);
    }
