 ...
 * 预览新图片
 */
public class PreviewNewImgActivity extends BageBaseActivity<ActPreviewNewImgLayoutBinding> {
    private String path;
    ...
    protected void rightLayoutClick() {
        ...
        GlideUtils.getInstance().compressImg(this, path, files -> {
            if (BageReader.isNotEmpty(files)) {
    ...
    protected void initView() {
        ...
        GlideUtils.getInstance().showImg(this, path, bageVBinding.imageView);
    }
