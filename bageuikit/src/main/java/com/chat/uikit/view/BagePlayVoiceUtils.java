 ...
 * 2021/8/2 17:01
 */
public class BagePlayVoiceUtils {
    private BagePlayVoiceUtils() {

    }

    private static class PlayVoiceUtilsBinder {
        static BagePlayVoiceUtils playVoiceUtils = new BagePlayVoiceUtils();
    }

    public static BagePlayVoiceUtils getInstance() {
