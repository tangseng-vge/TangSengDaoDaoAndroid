 ...
 * 搜索消息结果
 */
public class SearchMsgResultAdapter extends BaseQuickAdapter<BageMsg, BaseViewHolder> {
    private String searchKey;

    public SearchMsgResultAdapter(String searchKey, @Nullable List<BageMsg> data) {
        super(R.layout.item_search_msg_result_layout, data);
        this.searchKey = searchKey;
    }

    @Override
    protected void convert(@NotNull BaseViewHolder baseViewHolder, BageMsg msg) {
        ...
        //消息时间
        baseViewHolder.setText(R.id.timeTv, BageTimeUtils.getInstance().getTimeString(msg.timestamp * 1000));
