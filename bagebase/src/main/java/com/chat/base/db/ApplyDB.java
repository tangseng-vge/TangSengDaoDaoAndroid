...
public class ApplyDB {
    ...
    public synchronized long insert(NewFriendEntity friendEntity) {
        ...
        try {
            ...
            BageLogUtils.e("新增申请数据错误");
        }
        long result = -1;
        try {
            result = BageBaseApplication.getInstance().getDbHelper()
                    .insert(tableName, cv);
        } catch (Exception e) {
    ...
    public boolean update(NewFriendEntity friendEntity) {
        ...
        try {
            ...
            BageLogUtils.e("修改申请加好友数据错误");
        }
        return BageBaseApplication.getInstance().getDbHelper()
    ...
    public void delete(String uid) {
        ...
        where[0] = uid;
        BageBaseApplication.getInstance().getDbHelper().delete(tableName, "apply_uid=?", where);
    }
