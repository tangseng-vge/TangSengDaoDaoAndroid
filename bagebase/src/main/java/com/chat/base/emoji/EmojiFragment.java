 ...
 * emoji小表情fragment
 */
public class EmojiFragment extends BageBaseFragment<FragEmojiLayoutBinding> {
    ...
    protected void initView() {
        ...
        Theme.setColorFilter(getContext(), bageVBinding.deleteIv, R.color.popupTextColor);
        ...
        bageVBinding.recyclerView.setLayoutManager(new StaggeredGridLayoutManager(8, StaggeredGridLayoutManager.VERTICAL));
        bageVBinding.recyclerView.setAdapter(emojiAdapter);
