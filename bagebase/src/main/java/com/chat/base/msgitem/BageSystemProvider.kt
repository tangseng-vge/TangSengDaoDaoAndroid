...
class BageSystemProvider(val type: Int) : BageChatBaseProvider() {
    ...
    override fun convert(
        ...
        val content: String? = if (type == BageContentType.msgPromptTime) item.bageMsg.content else {
            getShowContent(item.bageMsg.content)
        }
