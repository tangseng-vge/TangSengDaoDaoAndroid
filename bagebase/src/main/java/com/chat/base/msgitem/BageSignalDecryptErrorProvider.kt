...
class BageSignalDecryptErrorProvider : BageChatBaseProvider() {
    ...
    override fun setData(
        ...
        bubbleLayout.setAll(bgType, from, BageContentType.Bage_SIGNAL_DECRYPT_ERROR)
    ...
    override val itemViewType: Int
        get() = BageContentType.Bage_SIGNAL_DECRYPT_ERROR
}