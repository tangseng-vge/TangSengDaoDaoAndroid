...
public class UserUtils {
    ...
    public boolean checkFriendRelation(String uid) {
        try {
            ...
            if (channel != null && channel.localExtra != null) {
                Object o = channel.localExtra.get(BageChannelExtras.beDeleted);
    ...
    public boolean checkBlacklist(String uid) {
        try {
            BageChannel channel = BageIM.getInstance().getChannelManager().getChannel(uid, BageChannelType.PERSONAL);
            if (channel != null && channel.localExtra != null) {
                Object o = channel.localExtra.get(BageChannelExtras.beBlacklist);
                if (o instanceof Integer) {
                    return (int) o == 1;
                }
            }
    ...
    public boolean checkInGroupOk(String channelId, String uid) {
        try {
            BageChannelMember channelMember = BageIM.getInstance().getChannelMembersManager().
                    getMember(channelId, BageChannelType.GROUP, uid);
