...
public class AndroidUtilities {
    ...
    public static void setDensity(float density1) {
        density = density1;
        Resources resources = BageBaseApplication.getInstance().getContext().getResources();
    ...
    public static void cancelRunOnUIThread(Runnable runnable) {
        if (BageBaseApplication.applicationHandler == null) {
            return;
        }
        BageBaseApplication.applicationHandler.removeCallbacks(runnable);
    }
    ...
    public static void runOnUIThread(Runnable runnable, long delay) {
        ...
        if (delay == 0) {
            BageBaseApplication.applicationHandler.post(runnable);
        } else {
            BageBaseApplication.applicationHandler.postDelayed(runnable, delay);
        }
    }
            ...
            if (!typefaceCache.containsKey(assetPath)) {
                try {
                    ...
                    if (Build.VERSION.SDK_INT >= 26) {
                        Typeface.Builder builder = new Typeface.Builder(BageBaseApplication.getInstance().getContext().getAssets(), assetPath);
                        ...
                        t = Typeface.createFromAsset(BageBaseApplication.getInstance().getContext().getAssets(), assetPath);
                    }
