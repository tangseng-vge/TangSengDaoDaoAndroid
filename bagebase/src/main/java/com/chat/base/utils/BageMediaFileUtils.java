 ...
 * 2020-11-10 18:16
 */
public class BageMediaFileUtils {
    private BageMediaFileUtils() {
    }

    private static class MediaFileUtilsBinder {
        final static BageMediaFileUtils fileUtils = new BageMediaFileUtils();
    }

    public static BageMediaFileUtils getInstance() {
    ...
    public String getVideoCover(String videoPath) {
        ...
        return BageFileUtils.getInstance().saveBitmap(null, bitmap);
    }
