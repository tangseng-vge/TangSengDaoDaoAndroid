 ...
 * gif消息
 */
public class BageGifContent extends BageMediaMessageContent implements Parcelable {
    public int width;
    public int height;
    ...
    public BageGifContent() {
        type = BageMsgContentType.Bage_GIF;
    }
    ...
    protected BageGifContent(Parcel in) {
        super(in);
        width = in.readInt();
        height = in.readInt();
        url = in.readString();
    ...
    public static final Creator<BageGifContent> CREATOR = new Creator<BageGifContent>() {
        @Override
        public BageGifContent createFromParcel(Parcel in) {
            return new BageGifContent(in);
        }

        @Override
        public BageGifContent[] newArray(int size) {
            return new BageGifContent[size];
        }
    };
