...
public class ChatViewMenu {
    ...
    public List<BageMessageContent> forwardMsgList;
    ...
    public ChatViewMenu(ComponentActivity activity, String channelID, byte channelType, long tipMsgOrderSeq, boolean isNewTask, List<BageMessageContent> forwardMsgList) {
        this.channelID = channelID;
        this.channelType = channelType;
        this.tipMsgOrderSeq = tipMsgOrderSeq;
        this.activity = activity;
