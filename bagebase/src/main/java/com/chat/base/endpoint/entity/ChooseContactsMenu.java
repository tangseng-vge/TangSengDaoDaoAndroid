...
public class ChooseContactsMenu {
    public int maxCount;
    public List<BageChannel> defaultSelected;
    ...
    public ChooseContactsMenu(int maxCount, boolean isCanDeselect, boolean isShowSaveLabelDialog, List<BageChannel> defaultSelected, IChooseBack iChooseBack) {
    ...
    public interface IChooseBack {
        void onBack(List<BageChannel> selectedList);
    }
}
