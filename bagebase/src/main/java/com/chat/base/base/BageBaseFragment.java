 ...
 * fragment基类
 */
public abstract class BageBaseFragment<BageVBinding extends ViewBinding> extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (mContentView == null) {
            ...
            mContentView = bageVBinding.getRoot();
    ...
    private void initTitleBar() {
        ...
        if (statusBarView != null && getContext() != null) {
            ...
            params.height = com.chat.base.utils.systembar.BageStatusBarUtils.getStatusBarHeight(getContext());
