...
public class BageFragmentStateAdapter extends FragmentStateAdapter {
    List<Fragment> fragmentList;
    private final List<Long> fragmentIds = new ArrayList<>();
    private final HashSet<Long> createIds = new HashSet<>();

    public BageFragmentStateAdapter(@NonNull FragmentManager fragmentManager, Lifecycle lifecycle, List<Fragment> fragmentList) {
        super(fragmentManager, lifecycle);
        setFragmentList(fragmentList);
    }

    public BageFragmentStateAdapter(@NonNull FragmentActivity fragmentActivity, List<Fragment> fragmentList) {
