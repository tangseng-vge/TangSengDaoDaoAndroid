...
public class Theme {
    ...
    public static final String bage_theme_pref = "bage_theme_pref";
...
//    };
    ...
    public static void applyTheme() {
        ...
        String themePref =
                BageSharedPreferencesUtil.getInstance().getSP(Theme.bage_theme_pref, Theme.DEFAULT_MODE);
    ...
    public static String getTheme() {
        ...
        return BageSharedPreferencesUtil.getInstance().getSP(Theme.bage_theme_pref, Theme.DEFAULT_MODE);
    }

    public static void setTheme(String s) {
        if (FORCE_LIGHT_THEME) {
            BageSharedPreferencesUtil.getInstance().putSP(Theme.bage_theme_pref, LIGHT_MODE);
            applyTheme(LIGHT_MODE);
            return;
        }
        BageSharedPreferencesUtil.getInstance().putSP(Theme.bage_theme_pref, s);
        Theme.applyTheme(s);
    }
    ...
    private static boolean isDarkThemePref() {
        String bage_theme_pref = BageSharedPreferencesUtil.getInstance().getSP(Theme.bage_theme_pref, Theme.DEFAULT_MODE);
        return DARK_MODE.equals(bage_theme_pref);
    }
    ...
    public static Drawable getTicksSingleDrawable() {
        if (ticksSingleDrawable == null) {
            RLottieDrawable drawable = new RLottieDrawable(BageBaseApplication.getInstance().getContext(), R.raw.ticks_single, "ticks_single", AndroidUtilities.dp(22), AndroidUtilities.dp(22));
    ...
    public static Drawable getTicksDoubleDrawable() {
        if (ticksDoubleDrawable == null) {
            RLottieDrawable drawable = new RLottieDrawable(BageBaseApplication.getInstance().getContext(), R.raw.ticks_double, "ticks_double", AndroidUtilities.dp(22), AndroidUtilities.dp(22));
            drawable.setCurrentFrame(drawable.getFramesCount() - 1);
