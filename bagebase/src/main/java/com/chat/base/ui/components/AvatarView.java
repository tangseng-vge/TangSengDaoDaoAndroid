...
//        imageView.setStrokeWidth(AndroidUtilities.dp(1));
    ...
    public void showAvatar(BageChannel channel) {
        showAvatar(channel, false);
    }

    public void showAvatar(BageChannel channel, boolean showOnlineStatus) {
    ...
    private String getAvatarURL(String channelID, byte channelType) {
        String filePath = BageConstants.avatarCacheDir + channelType + "_" + channelID;
