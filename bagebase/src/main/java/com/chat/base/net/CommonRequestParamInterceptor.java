...
public class CommonRequestParamInterceptor implements Interceptor {
    ...
    private Map<String, String> getCommonParams() {
        ...
        mCommonParams.put("token", BageConfig.getInstance().getToken());
        mCommonParams.put("model", Build.MODEL);
        mCommonParams.put("os", "Android");
        mCommonParams.put("appid", BageBaseApplication.getInstance().appID);
        mCommonParams.put("version", BageBaseApplication.getInstance().versionName);
        mCommonParams.put("package", BageBaseApplication.getInstance().packageName);
