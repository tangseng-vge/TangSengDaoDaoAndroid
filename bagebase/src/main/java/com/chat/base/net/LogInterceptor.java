...
public class LogInterceptor implements Interceptor {
    ...
    public Response intercept(@NotNull Chain chain) throws IOException {
        ...
        if (BageBinder.isDebug) {
            ...
            if (requestBody != null && !requestBody.isOneShot()) {
                ...
                if (isPlainText(type) && isWithinLimit(contentLength)) {
                    ...
                    try {
                        ...
                        BageLogUtils.e("LogInterceptor request log error: " + e.getMessage());
                    } finally {
                        Util.closeQuietly(source);
                    }
                } else {
                    BageLogUtils.d("bageHttpLog", "Request body skipped - type:" + type + ", length:" + contentLength);
                }
            }
            // 请求日志
            ...
            BageLogUtils.d("bageHttpLog", reqSb.toString());
