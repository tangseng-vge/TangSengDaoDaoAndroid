 ...
 * 剪切图片
 */
public class BageCropImageActivity extends BageBaseActivity<ActCutImgLayoutBinding> {
    ...
    protected void rightLayoutClick() {
        ...
        Bitmap bitmap = bageVBinding.cropImageView.getCroppedImage();
        if (bitmap != null) {
    ...
    protected void rightLeftLayoutClick() {
        ...
        rotate = rotate + 90;
        bageVBinding.cropImageView.rotateImage(rotate);
    }
    ...
    protected void initView() {
        ...
        if (!TextUtils.isEmpty(path)) {
            ...
            bageVBinding.cropImageView.setImageBitmap(bitmap);
        }
    }
}
